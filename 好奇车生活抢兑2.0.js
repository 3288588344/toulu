...
async function userTask(user) {
    DoubleLog(`\n========== 账号[${user.index}]开始抢兑 ==========`)
    const taskIds = ['792556957722198016', '792556468305641472', '754493262869991424', '754493011522113536', '754492665391370240'];
    const exchangeCountid = ['9155', '305', '3', '3', '29331'];
    const exchangeNeedPointsid = ['1800', '750', '588', '888', '188'];
